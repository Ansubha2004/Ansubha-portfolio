...
function Homescreen() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[#707070] text-[1.3rem] sm:text-[1.5rem] ">
          Hi! I am
        </p>
        <p className="text-[#959595] text-[1.4rem] sm:text-[1.6rem] font-[500]">
          ANSUBHA DHAR
        </p>
        <p className=" sm:text-[3.9rem] mt-2 sm:mt-0 mb-3  text-[3.2rem] bg-gradient-to-r from-[#984300] via-[#FD6F00] to-[#CA5900] text-transparent bg-clip-text font-[900]">
          WEB DEVELOPER
        </p>
        <div className="flex justify-center items-center mb-10 space-x-7 sm:space-x-10">
        ...
        <div className="w-[90%] sm:w-full h-[100px]  sm:h-[20%] rounded-[15px] bg-[#FFFFFF10] border-box py-[20px] flex justify-between items-center">
      ...
      >
        <img src={profilepic} className="h-[100%] translate-x-[-1rem]" />
      </section>
    </div>
  );
}
