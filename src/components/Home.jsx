    ...
    <div className="overflow-hidden">
        <main className="h-screen w-screen font-[poppins] flex sm:flex-row  flex-col sm:justify-around items-center ">
            <div className="h-auto max-w-[50%] " id="content">
                ...
                <br/>
                <p className="text-[#556070] sm:text-[18px]  " data-aos="zoom-out-up" data-aos-delay="1000">Hi! I am a passionate Web Developer as well as an undergraduate Electrical Engineer, from the city of Kolkata in West Bengal, India. I am open to collab for any web application projects or Hackathons & also seeking for intership opportunities. </p>
                <br/>
