...
export default function Profilecard() {
    ...
    <div className="h-screen w-screen flex justify-center items-center ">
      <div data-aos="fade-right"  className=" h-auto rounded-[20px] box-border px-[50px] py-[90px] min-w-[1000px] w-[70%] bg-orange-200 flex mt-[25px]">
        <div className="min-w-[50%] flex flex-col items-center relative">
            ...
            <div data-aos="fade" data-aos-delay="800" className="bg-orange-200 absolute bottom-[-37px] flex w-[50%] justify-evenly py-[10px] rounded-[7px] shadow-[0px_3px_20px_rgba(0,0,0,0.3)]">
